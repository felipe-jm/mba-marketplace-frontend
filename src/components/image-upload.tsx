  ...
  return (
    <div>
      <div
        ...
        className={cn(
          "flex flex-col justify-center items-center w-[120px] h-[120px] bg-shape-shape rounded-xl cursor-pointer",
          className
        )}
      >
        <input
        ...
        {preview && (
          <div className="relative w-full h-full rounded-xl">
            ...
            <div className="group absolute flex flex-col gap-4 items-center justify-center w-full h-full z-10 rounded-xl transition-colors hover:bg-black/60">
              ...
              {label && (
                <span className="text-center text-body-sm font-poppins text-shape-white hidden group-hover:block">
                  {label}
                </span>
              )}
            </div>
        ...
        {!preview && (
          <div className="flex flex-col gap-4 items-center justify-center">
            ...
            {label && (
              <span className="text-center text-body-sm font-poppins text-grayscale-300">
                {label}
              </span>
            )}
          </div>
