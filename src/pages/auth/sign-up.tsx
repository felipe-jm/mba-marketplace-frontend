...
const signUpForm = z
  .object({
    ...
    name: z
      .string()
      .min(1, { message: "O nome precisa ter pelo menos 1 caractere." }),
    phone: z
      .string()
      .min(1, { message: "O telefone precisa ter pelo menos 1 caractere." }),
...
export function SignUp() {
  ...
  return (
    <>
      <Helmet title="MBA Marketplace - Crie sua conta" />
      ...
      <div className="flex flex-col w-full h-[calc(100vh-48px)] overflow-y-auto rounded-[32px] bg-shape-white px-20 py-[72px]">
        ...
        >
          ...
          <div className="flex flex-col gap-5">
            <p className="font-bold text-title-sm font-sans text-grayscale-500">
              Perfil
            </p>
